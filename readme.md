# Ted X App [![Build Status](https://travis-ci.org/NativeScript/sample-Groceries.svg?branch=release)](https://travis-ci.org/NativeScript/sample-Groceries)

Ted Rss App is an Ionic Android/IOS that retrieves the latest ted X talks.

<h2 id="screenshots">Screenshots</h2>

![](assets/screenshots/ted_a.png)
![](assets/screenshots/ted_b.png)
...
```
$ git clone https://github.com/emodatt08/TedX-talks-app.git
$ cd <project name>
```
